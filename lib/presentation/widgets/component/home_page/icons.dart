    ...
    return Row(
      ...
      children: [
        ...
        CustomIcon(
          ...
          color: BaseColors().getWhiteColor(),widget: ExtratoPage(), context: context,  logout: false,
        ),
        // help para Ajuda com o App
        CustomIcon(
          icon: MdiIcons.helpCircleOutline,
          color: BaseColors().getWhiteColor(), widget: HelpPage(), context: context,  logout: false,
        ),
        // email para Convidar amigos
        CustomIcon(
          icon: Icons.logout_sharp,
          color: BaseColors().getWhiteColor(),context: context, widget: MyApp(), logout: true,
        ),
      ],
    );
  }
